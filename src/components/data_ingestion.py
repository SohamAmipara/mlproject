# This code is part of a data ingestion pipeline that reads a dataset, splits it into training and testing sets,
# and saves the results to specified paths. It also includes error handling and logging for better traceability.
